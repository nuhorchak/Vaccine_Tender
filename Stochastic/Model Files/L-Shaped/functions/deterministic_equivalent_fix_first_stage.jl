...
function deterministic_equivalent_fix_first_stage(p_ω, Ω, g, beta, Γ, gurobi_solver_DE,
    ...
    data_dir = joinpath(current_directory, "..", "results/DE_demand_increase_sensitivity/base-base_demand+2%")
    filename = "DE_base_base+2.json"
