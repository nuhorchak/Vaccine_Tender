...
for name in first(sheet_names, total_scenarios) #change the number based on scenario numbers
    ...
    for row in 2:total_demand_row
        ...
        for col in 2:total_demand_col
            year = data[1,col]
            d_real[antigen,parse(Int64, year),ω] = data[row,col]
        end
    end
end
# println(d_real)
...
for row in 2:total_row_Q
    ...
    amount = starting_points_Q_raw[row,5]*unit
...
for row in 2:total_row_I
    ...
    amount = starting_points_I_raw[row,2]*unit
...
for row in 2:total_row_S
    ...
    amount = starting_points_S_raw[row,2]*100
...
# # Constraint (14) - starting points for F
...
# # Constraint (15) - starting points for Q
...
# # Constraint (16) - starting points for I
# for ω in Ω
...
# # Constraint (17) - starting points for S
# for ω in Ω
