...
function select_random_scenarios(a::Int, b::Int, n::Int, total_capacity_scenarios::Int, seed::Int)
    ...
    # Make pairs with all the capacity scenarios
    randomly_selected_scenarios = vcat([(i-1) * total_capacity_scenarios .+ (1:total_capacity_scenarios) for i in selected_numbers]...)
