        ...
        while iter1 <= iter_max
            ...
            if termination_status(Masterproblem) == MOI.OPTIMAL
                ...
                for ω in Ω_test_partial_2
                    ...
                    if termination_status(Subproblem) == MOI.INFEASIBLE
                        sub_infeas = true
                        break
                    end
            ...
            elseif primal_status(Masterproblem) == MOI.NO_SOLUTION || MOI.INFEASIBLE || sub_infeas == True
