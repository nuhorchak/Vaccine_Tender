...
gurobi_solver = JuMP.optimizer_with_attributes(Gurobi.Optimizer, "FeasibilityTol"=>1e-6, "TIME_LIMIT" => 60.0) #"TIME_LIMIT" => 20.0, #"Presolve" => 0
...
@variable(model, F[a in A, (t,tau) in F_time_set], Bin, start = F_warm[a,(t,tau)])
