...
# def create_market_visualizations(df, market_share, participation, vaccine_participation, mfr_vaccine_discount, output_dir='/home/claude/market_plots'):
...
#     plt.tight_layout()
#     plt.savefig(f'{output_dir}/01_market_share_heatmap.png', dpi=300, bbox_inches='tight')
#     plt.close()
...
#     ax.set_ylabel('Manufacturer', fontsize=12)
#     plt.tight_layout()
#     plt.savefig(f'{output_dir}/02_participation_rate_heatmap.png', dpi=300, bbox_inches='tight')
#     plt.close()
...
#     plt.tight_layout()
#     plt.savefig(f'{output_dir}/03_quantity_by_discount_stacked.png', dpi=300, bbox_inches='tight')
#     plt.close()
...
#     plt.tight_layout()
#     plt.savefig(f'{output_dir}/04_participation_vs_share_bubble.png', dpi=300, bbox_inches='tight')
#     plt.close()
...
#     plt.tight_layout()
#     plt.savefig(f'{output_dir}/05_vaccine_participation_heatmap.png', dpi=300, bbox_inches='tight')
#     plt.close()
...
#     plt.tight_layout()
#     plt.savefig(f'{output_dir}/06_avg_quantity_by_discount.png', dpi=300, bbox_inches='tight')
#     plt.close()
...
#     plt.tight_layout()
#     plt.savefig(f'{output_dir}/07_vaccine_manufacturer_discount_facets.png', dpi=300, bbox_inches='tight')
#     plt.close()
...
#     ax.grid(True, alpha=0.3)
#     plt.tight_layout()
#     plt.savefig(f'{output_dir}/08_market_share_evolution.png', dpi=300, bbox_inches='tight')
#     plt.close()
    
#     print(f"\n✓ All market participation visualizations saved to {output_dir}/")

# def create_summary_report(market_share, participation, vaccine_participation, output_file='/home/claude/market_participation_report.txt'):
...
#     all_data = load_all_q_data('/mnt/user-data/uploads')
...
#     market_share.to_csv('/home/claude/market_share_by_discount.csv', index=False)
#     participation.to_csv('/home/claude/participation_by_manufacturer_discount.csv', index=False)
#     vaccine_participation.to_csv('/home/claude/vaccine_participation_by_discount.csv', index=False)
#     mfr_vaccine_discount.to_csv('/home/claude/manufacturer_vaccine_discount.csv', index=False)
#     print("✓ Data files saved\n")
    
#     # Create visualizations
#     print("Creating market participation visualizations...")
#     create_market_visualizations(df, market_share, participation, vaccine_participation, mfr_vaccine_discount)
    
#     # Create summary report
#     print("\nGenerating summary report...")
#     create_summary_report(market_share, participation, vaccine_participation)
...
#     print("  6. market_plots/ - 8 specialized visualizations")
