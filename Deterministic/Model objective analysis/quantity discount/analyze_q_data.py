...
# def create_visualizations(df, output_dir='/analysis/Q plots'):
...
#     plt.tight_layout()
#     plt.savefig(f'{output_dir}/01_quantity_distribution.png', dpi=300, bbox_inches='tight')
#     plt.close()
...
#     plt.tight_layout()
#     plt.savefig(f'{output_dir}/02_quantity_by_vaccine.png', dpi=300, bbox_inches='tight')
#     plt.close()
...
#     plt.xticks(rotation=45, ha='right')
#     plt.tight_layout()
#     plt.savefig(f'{output_dir}/03_quantity_by_manufacturer.png', dpi=300, bbox_inches='tight')
#     plt.close()
...
#     plt.tight_layout()
#     plt.savefig(f'{output_dir}/04_quantity_by_time_start.png', dpi=300, bbox_inches='tight')
#     plt.close()
...
#     plt.tight_layout()
#     plt.savefig(f'{output_dir}/05_vaccine_manufacturer_heatmap.png', dpi=300, bbox_inches='tight')
#     plt.close()
...
#     plt.tight_layout()
#     plt.savefig(f'{output_dir}/06_quantity_by_trial.png', dpi=300, bbox_inches='tight')
#     plt.close()
...
#     ax.set_ylabel('Total Quantity')
#     plt.tight_layout()
#     plt.savefig(f'{output_dir}/07_quantity_by_discount.png', dpi=300, bbox_inches='tight')
#     plt.close()
...
#     ax.set_ylabel('Total Quantity')
#     plt.tight_layout()
#     plt.savefig(f'{output_dir}/08_quantity_by_duration.png', dpi=300, bbox_inches='tight')
#     plt.close()
...
#     plt.tight_layout()
#     plt.savefig(f'{output_dir}/09_time_period_heatmap.png', dpi=300, bbox_inches='tight')
#     plt.close()
    
#     print(f"\n✓ All visualizations saved to {output_dir}/")

# def generate_report(stats, df, output_file='/home/claude/statistical_report.txt'):
...
#     all_data = load_all_q_data('/results/buyer discounts/2 segments/UG')
...
#     # Save raw data
#     df.to_csv('/analysis/q_data_flattened.csv', index=False)
#     print("✓ Saved flattened data to q_data_flattened.csv")
...
#     with pd.ExcelWriter('/analysis/q_statistics.xlsx', engine='openpyxl') as writer:
...
#     print("✓ Statistics saved to q_statistics.xlsx")
...
#     print("  4. plots/ - 9 visualization charts")
