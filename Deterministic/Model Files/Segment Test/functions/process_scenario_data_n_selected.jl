function process_scenario_data_n_selected(
    ...
    scenario_pair_probs_path = joinpath(data_dir, "/NEW/scenario_pair_probabilities_new_ratio_0.05.json")
    scenario_pair_probs = JSON.parsefile(scenario_pair_probs_path)
    ...
    # Load scenario pairs
    scenario_pairs_path = joinpath(data_dir, "/NEW/scenario_pairs_new_ratio_0.05.json")
    scenario_pairs = JSON.parsefile(scenario_pairs_path)
